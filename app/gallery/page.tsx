    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="mesh-gradient py-20 pt-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6 text-center relative z-10">
          <AnimatedSection>
            <p className="text-amber-400 text-xs font-bold tracking-[0.15em] uppercase mb-3">OUR GALLERY</p>
            <h1 className="font-heading text-4xl md:text-5xl font-extrabold text-white mb-4">
              Campus <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-emerald-400">Moments</span>
            </h1>
            <p className="text-slate-300 max-w-2xl mx-auto">
              A glimpse into life at STC Umerkot — events, classroom activities, and campus highlights.
            </p>
          </AnimatedSection>
        </div>
      </section>
